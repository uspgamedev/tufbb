...
func _ready():
	...
	troca_cor(1, 1, 0, 0, 1, 0, 0.1)
	troca_cor(0, 1, 0, 0, 1, 1, 0.2)
	troca_cor(0, 1, 1, 0, 0, 1, 0.3)
	troca_cor(0, 0, 1, 1, 0, 1, 0.4)
	troca_cor(1, 0, 1, 1, 0, 0, 0.5)
...
func troca_cor(r1, g1, b1, r2, g2, b2, tempo):
	...
	tween.interpolate_method(self, "set_modulate", color_from, color_to, 0.1, state.trans, state.eases, tempo)
